# ============================================================================ #
# Vendored from kaggle-environments 1.32.7 (PyPI), pinned per issue 001.
#   Path upstream: kaggle_environments/envs/kaggriculture/kaggriculture.py
#   Wheel sha256:  2a1bb862ad2d6463080f80f6a766f46d94b53fd57168cfeddb9857fc3dbc4c8f
#   Uploaded:      2026-08-15T01:35:47Z (https://pypi.org/pypi/kaggle-environments/1.32.7/json)
#   Upstream repo: https://github.com/Kaggle/kaggle-environments — no git tag
#                  exists for 1.32.x releases (tags stop at 1.18.0), so the
#                  wheel sha256 above is the only available provenance anchor.
#   Includes PR #1394 (released as 1.32.6, 2026-08-07) and PR #1399 (released
#   as 1.32.7, 2026-08-15). See notes/engine-version.md for the full changelog.
#   Do not hand-edit — regenerate by copying from the installed .venv package
#   when the pin in pyproject.toml changes.
# ============================================================================ #
